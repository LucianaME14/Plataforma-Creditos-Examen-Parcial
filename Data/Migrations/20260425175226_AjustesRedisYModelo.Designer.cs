...
namespace PlataformaCreditos.Data.Migrations
{
    ...
    [Migration("20260425175226_AjustesRedisYModelo")]
    partial class AjustesRedisYModelo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlataformaCreditos.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PlataformaCreditos.Models.Cliente", b =>
                {
                    ...
                    b.ToTable("Clientes", t =>
                        {
                            t.HasCheckConstraint("CK_IngresosMensuales", "IngresosMensuales > 0");
                        });
                });
            ...
            modelBuilder.Entity("PlataformaCreditos.Models.SolicitudCredito", b =>
                {
                    ...
                    b.ToTable("Solicitudes", t =>
                        {
                            t.HasCheckConstraint("CK_MontoSolicitado", "MontoSolicitado > 0");
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PlataformaCreditos.Models.ApplicationUser", null)
                        .WithMany()
