...
{
    /// <inheritdoc />
    public partial class AjustesRedisYModelo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_IngresosMensuales", "IngresosMensuales > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MontoSolicitado", "MontoSolicitado > 0");
                    table.ForeignKey(
